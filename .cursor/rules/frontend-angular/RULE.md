---
description: "Angular frontend standards for the treasure hunt application - component structure, services, routing, and mobile-first design"
alwaysApply: false
globs:
  - "frontend/**/*.ts"
  - "frontend/**/*.html"
...
- **Early returns**: Exit functions early to avoid nested conditionals
- **Type safety**: Leverage TypeScript strict mode throughout
- **Reactive patterns**: Use RxJS observables for async operations
...
├── features/       # Feature modules (auth, puzzles, hints)
...
- Keep sensitive data out of environment files (use backend for secrets)
...
- [ ] Type all properties and method returns
- [ ] Follow BEM naming in templates
- [ ] Mobile-first styling with SCSS
- [ ] Handle loading and error states
- [ ] Write unit tests for critical logic
- [ ] Use proper Angular lifecycle hooks
- [ ] Cleanup subscriptions with takeUntil
