---
description: "Node.js/TypeScript backend API standards - Express routing, middleware, database queries, authentication, and error handling"
alwaysApply: false
globs:
  - "backend/**/*.ts"
  - "backend/**/*.js"
...
- **Single responsibility**: Each function/middleware does one thing well
- **Fail fast**: Validate inputs immediately, throw descriptive errors
...
- Release clients back to pool in finally blocks
